...
// Винести це за межі компонента, перед export function CarpalGallery
const DEFAULT_IMAGES: GalleryImage[] = [
  ...
  },
  {
    ...
    alt: "Симптоми карпального синдрому",
    width: 600,
    height: 400,
    title: "Симптоми карпального синдрому",
  },
]
...
interface CarpalGalleryProps {
  images?: GalleryImage[]
}

export function CarpalGallery({ images }: CarpalGalleryProps) {
