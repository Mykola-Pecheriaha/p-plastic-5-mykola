...
import styles from "./GinecomastiyaPreparationGallery.module.css"
...
interface GinecomastiyaPreparationGalleryProps {
  images: GalleryImage[]
}

export function GinecomastiyaPreparationGallery({ images }: GinecomastiyaPreparationGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=підготовка+до+операції"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=підготовка+мініатюра"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default GinecomastiyaPreparationGallery
