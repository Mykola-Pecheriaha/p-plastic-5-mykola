...
import styles from "./MastopexyInfoGallery.module.css"
...
interface MastopexyInfoGalleryProps {
  images: GalleryImage[]
}

export function MastopexyInfoGallery({ images }: MastopexyInfoGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=400&query=mastopexy+info"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=mastopexy+thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default MastopexyInfoGallery
