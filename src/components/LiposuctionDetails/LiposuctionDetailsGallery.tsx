...
import styles from "./LiposuctionDetailsGallery.module.css"
...
interface LiposuctionDetailsGalleryProps {
  images: GalleryImage[]
}

export function LiposuctionDetailsGallery({ images }: LiposuctionDetailsGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=liposuction details"}
...
export default LiposuctionDetailsGallery
