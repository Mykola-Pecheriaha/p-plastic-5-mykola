...
import styles from "./OttoDetailsGallery.module.css"
...
interface OttoDetailsGalleryProps {
  images: GalleryImage[]
}

export function OttoDetailsGallery({ images }: OttoDetailsGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=otoplasty"}
            alt={currentImage.alt || "Отопластика"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=otoplasty thumbnail"}
                      alt={image.alt || "Отопластика мініатюра"}
                      width={100}
                      height={75}
...
export default OttoDetailsGallery
