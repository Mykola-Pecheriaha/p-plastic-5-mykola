...
import styles from "./BlepharoPreparationGallery.module.css"
...
interface BlepharoPreparationGalleryProps {
  images: GalleryImage[]
  galleryId?: string
}

export function BlepharoPreparationGallery({ images, galleryId }: BlepharoPreparationGalleryProps) {
    ...
    <div className={styles.galleryContainer} id={galleryId}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=blepharoplasty preparation"}
              ...
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src || "/placeholder.svg?height=75&width=100&query=blepharoplasty preparation thumbnail"
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default BlepharoPreparationGallery
