...
import styles from "./AnalFissureGallery.module.css"
...
interface AnalFissureGalleryProps {
  images?: GalleryImage[]
}

// Зображення за замовчуванням для AnalFissureGallery
const defaultImages: GalleryImage[] = [
  {
    src: "/images/analFissure/analFissure4.jpg",
    alt: "Анатомія анальної тріщини",
    width: 600,
    height: 400,
    title: "Анатомічна будова анальної тріщини",
  },
  {
    ...
    width: 600,
    height: 400,
    title: "Гостра форма анальної тріщини",
  },
  {
    ...
    width: 600,
    height: 400,
    title: "Хронічна форма анальної тріщини",
  },
  {
...
export function AnalFissureGallery({ images = defaultImages }: AnalFissureGalleryProps) {
