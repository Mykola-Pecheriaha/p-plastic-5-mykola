...
import styles from "./TreatmentAnalFissureGallery.module.css"
...
interface TreatmentAnalFissureGalleryProps {
  images?: GalleryImage[]
}

// Зображення за замовчуванням для TreatmentAnalFissureGallery
const defaultImages: GalleryImage[] = [
  ...
  },
  {
    ...
    width: 600,
    height: 400,
    title: "Медикаментозна терапія анальної тріщини",
  },
  {
  ...
  },
  {
    ...
    width: 600,
    height: 400,
    title: "Лазерна терапія анальної тріщини",
  },
]

export function TreatmentAnalFissureGallery({ images = defaultImages }: TreatmentAnalFissureGalleryProps) {
