...
import styles from "./OttoFAQGallery.module.css"
...
interface OttoFAQGalleryProps {
  images: GalleryImage[]
}

export function OttoFAQGallery({ images }: OttoFAQGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=otto faq"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=otto faq thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
