...
import styles from "./LiposuctionIndicatioGallery.module.css"
...
interface LiposuctionIndicatioGalleryProps {
  images: GalleryImage[]
}

export function LiposuctionIndicatioGallery({ images }: LiposuctionIndicatioGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=liposuction indications"}
...
export default LiposuctionIndicatioGallery
