...
import styles from "./GerniotomiyaIndicatioGallery.module.css"
...
interface GerniotomiyaIndicatioGalleryProps {
  images: GalleryImage[]
}

export function GerniotomiyaIndicatioGallery({ images }: GerniotomiyaIndicatioGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=gerniotomiya indicatio"}
...
export default GerniotomiyaIndicatioGallery
