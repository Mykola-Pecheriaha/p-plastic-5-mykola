...
import styles from "./SymptomsVaricoseGallery.module.css"
...
const DEFAULT_IMAGES: GalleryImage[] = [
  {
    ...
    alt: "Симптоми варикозу - біль",
    width: 800,
    height: 600,
    title: "Біль та дискомфорт при варикозі",
  },
  {
    src: "/images/varicose/varicos18.jpg",
    alt: "Набряки при варикозі",
    width: 800,
    height: 600,
  ...
  },
  {
    ...
    width: 800,
    height: 600,
    title: "Стадії розвитку варикозної хвороби",
  },
  {
...
interface SymptomsVaricoseGalleryProps {
  images?: GalleryImage[]
}

export function SymptomsVaricoseGallery({ images }: SymptomsVaricoseGalleryProps) {
...
export default SymptomsVaricoseGallery
