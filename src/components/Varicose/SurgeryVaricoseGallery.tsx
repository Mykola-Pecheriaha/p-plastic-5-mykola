...
import styles from "./SurgeryVaricoseGallery.module.css"
...
const DEFAULT_IMAGES: GalleryImage[] = [
  {
    ...
    alt: "Склеротерапія варикозу",
    width: 800,
    height: 600,
    title: "Склеротерапія - сучасний метод лікування",
  },
  {
    ...
    width: 800,
    height: 600,
    title: "Лазерне лікування варикозних вен",
  },
  {
    src: "/images/varicose/varicos24.jpg",
    alt: "Результати лікування варикозу",
    width: 800,
    height: 600,
    title: "Результати хірургічного лікування",
  },
  {
...
interface SurgeryVaricoseGalleryProps {
  images?: GalleryImage[]
}

export function SurgeryVaricoseGallery({ images }: SurgeryVaricoseGalleryProps) {
...
export default SurgeryVaricoseGallery
