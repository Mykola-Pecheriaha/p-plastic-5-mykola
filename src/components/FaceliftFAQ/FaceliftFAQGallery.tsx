...
import styles from "./FaceliftFAQGallery.module.css"
...
interface FaceliftFAQGalleryProps {
  images: GalleryImage[]
}

export function FaceliftFAQGallery({ images }: FaceliftFAQGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=facelift faq"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=facelift faq thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default FaceliftFAQGallery
