...
import styles from "./BlepharoplastytDetailsGallery.module.css"
...
interface BlepharoplastytDetailsGalleryProps {
  images: GalleryImage[]
  galleryId?: string
}

export function BlepharoplastytDetailsGallery({ images, galleryId }: BlepharoplastytDetailsGalleryProps) {
    ...
    <div className={styles.galleryContainer} id={galleryId}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=blepharoplasty details"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=blepharoplasty thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default BlepharoplastytDetailsGallery
