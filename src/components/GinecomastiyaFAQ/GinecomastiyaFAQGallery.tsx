...
import styles from "./GinecomastiyaFAQGallery.module.css"
...
interface GinecomastiyaFAQGalleryProps {
  images: GalleryImage[]
}

export function GinecomastiyaFAQGallery({ images }: GinecomastiyaFAQGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=gynecomastia faq"}
        ...
        <div className={styles.fullscreenOverlay} onClick={closeFullscreen}>
          <div className={styles.fullscreenContent} onClick={e => e.stopPropagation()}>
            ...
            <div className={styles.fullscreenImageContainer}>
              <Image
                src={currentImage.src || "/placeholder.svg?height=600&width=800&query=gynecomastia faq fullscreen"}
                alt={currentImage.alt}
                width={currentImage.width}
                height={currentImage.height}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=gynecomastia faq thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default GinecomastiyaFAQGallery
