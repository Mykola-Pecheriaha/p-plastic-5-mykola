...
import styles from "./FaceLiftPreparationGallery.module.css"
...
interface FaceLiftPreparationGalleryProps {
  images: GalleryImage[]
  galleryId?: string
}

export function FaceLiftPreparationGallery({ images, galleryId }: FaceLiftPreparationGalleryProps) {
    ...
    <div className={styles.galleryContainer} id={galleryId}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=facelift preparation"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=facelift preparation thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default FaceLiftPreparationGallery
