...
import styles from "./PararectalFistulasGallery.module.css"
...
interface PararectalFistulasGalleryProps {
  images?: GalleryImage[]
}

// Зображення за замовчуванням для PararectalFistulasGallery
const defaultImages: GalleryImage[] = [
  {
    ...
    width: 600,
    height: 400,
    title: "Анатомічна будова параректальної нориці",
  },
  {
    src: "/images/pararectal/pararecta6.jpg",
    alt: "Види параректальних нориць",
    width: 600,
    height: 400,
    title: "Класифікація параректальних нориць",
  },
  {
    src: "/images/pararectal/pararecta7.jpg",
    alt: "Формування параректальної нориці",
    width: 600,
    height: 400,
    title: "Процес формування параректальної нориці",
  },
  {
...
export function PararectalFistulasGallery({ images = defaultImages }: PararectalFistulasGalleryProps) {
...
export default PararectalFistulasGallery
