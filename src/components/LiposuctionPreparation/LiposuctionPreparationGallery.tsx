...
import styles from "./LiposuctionPreparationGallery.module.css"
...
interface LiposuctionPreparationGalleryProps {
  images: GalleryImage[]
}

export function LiposuctionPreparationGallery({ images }: LiposuctionPreparationGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=liposuction preparation"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=liposuction thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default LiposuctionPreparationGallery
