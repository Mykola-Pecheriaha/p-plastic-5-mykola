...
interface ContraIndicationsGalleryProps {
  images: GalleryImage[]
}

export function ContraIndicationsGallery({ images }: ContraIndicationsGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=400&query=contraindications"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=contraindications+thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default ContraIndicationsGallery
