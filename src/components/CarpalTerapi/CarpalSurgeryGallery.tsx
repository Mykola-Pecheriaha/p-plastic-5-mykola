...
import styles from "./CarpalSurgeryGallery.module.css"
...
interface CarpalSurgeryGalleryProps {
  images?: GalleryImage[]
}

export function CarpalSurgeryGallery({ images = [] }: CarpalSurgeryGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=carpal surgery"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {safeImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=carpal surgery thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
