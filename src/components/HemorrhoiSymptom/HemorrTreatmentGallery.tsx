...
interface HemorrTreatmentGalleryProps {
  images: GalleryImage[]
}

export function HemorrTreatmentGallery({ images }: HemorrTreatmentGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=hemorrhoid treatment"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=hemorrhoid treatment thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
