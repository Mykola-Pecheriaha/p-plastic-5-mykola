...
import styles from "./CarpalResultGallery.module.css"
...
interface CarpalResultGalleryProps {
  images?: GalleryImage[]
}
...
const DEFAULT_IMAGES: GalleryImage[] = [
  {
    ...
    width: 800,
    height: 600,
    title: "Успішні результати лікування",
  },
  {
    src: "/images/carpal-reabil/carpale49.jpg",
    alt: "Відновлення функції руки",
    width: 800,
    height: 600,
    title: "Повне відновлення функції",
  },
  {
    src: "/images/carpal-reabil/carpale50.jpg",
    alt: "Задоволені пацієнти",
    width: 800,
    height: 600,
...
export function CarpalResultGallery({ images }: CarpalResultGalleryProps) {
...
export default CarpalResultGallery
