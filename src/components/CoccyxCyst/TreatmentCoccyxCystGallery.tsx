...
import styles from "./TreatmentCoccyxCystGallery.module.css"
...
interface TreatmentCoccyxCystGalleryProps {
  images?: GalleryImage[]
}

// Зображення за замовчуванням для TreatmentCoccyxCystGallery
const defaultImages: GalleryImage[] = [
  {
    ...
    width: 600,
    height: 400,
    title: "Консервативні методи лікування",
  },
  {
    ...
    width: 600,
    height: 400,
    title: "Хірургічні методи лікування",
  },
  {
    src: "/images/coccyx/coccyx12.jpg",
    alt: "Лазерне лікування кісти куприка",
    width: 600,
    height: 400,
    title: "Лазерна терапія кісти куприка",
  },
  {
  ...
  },
  {
    ...
    alt: "Профілактика кісти куприка",
    width: 600,
    height: 400,
    title: "Профілактичні заходи",
  },
]

export function TreatmentCoccyxCystGallery({ images = defaultImages }: TreatmentCoccyxCystGalleryProps) {
