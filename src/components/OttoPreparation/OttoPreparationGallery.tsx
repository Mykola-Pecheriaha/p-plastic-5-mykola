...
import styles from "./OttoPreparationGallery.module.css"
...
interface OttoPreparationGalleryProps {
  images: GalleryImage[]
}

export function OttoPreparationGallery({ images }: OttoPreparationGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=otoplasty preparation"}
            alt={currentImage.alt || "Підготовка до отопластики"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=otoplasty preparation thumbnail"}
                      alt={image.alt || "Підготовка до отопластики мініатюра"}
                      width={100}
                      height={75}
...
export default OttoPreparationGallery
