...
import styles from "./SymptomsGallery.module.css"
...
interface SymptomsGalleryProps {
  images?: GalleryImage[]
}

const DEFAULT_IMAGES: GalleryImage[] = [
  {
    src: "/images/carpale-details/carpale16.jpg",
    alt: "Оніміння та поколювання в руці",
    width: 600,
    height: 400,
    title: "Оніміння та поколювання в руці",
  },
  {
    src: "/images/carpale-details/carpale27.jpg",
    alt: "Нічні симптоми",
    width: 600,
    height: 400,
    title: "Нічні симптоми",
  },
  {
    src: "/images/carpale-details/carpal5.jpg",
    alt: "Слабкість хвату",
    width: 600,
    height: 400,
    title: "Слабкість хвату",
  },
  {
    src: "/images/carpale-details/carpale29.jpg",
    alt: "Слабкість хвату",
    width: 600,
    height: 400,
    title: "Слабкість хвату",
...
export function SymptomsGallery({ images }: SymptomsGalleryProps) {
