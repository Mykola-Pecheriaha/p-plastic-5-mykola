...
import styles from "./CausesGallery.module.css"
...
interface CausesGalleryProps {
  images?: GalleryImage[]
}

const DEFAULT_IMAGES: GalleryImage[] = [
  {
    src: "/images/carpale-details/carpal7.jpg",
    alt: "Повторювані рухи рук",
    width: 600,
    height: 400,
    title: "Повторювані рухи рук",
  },
  {
    src: "/images/carpale-details/carp56.jpg",
    alt: "Робота за комп'ютером",
    width: 600,
    height: 400,
    title: "Робота за комп'ютером",
  },
  {
    src: "/images/carpale-details/carpale25.jpg",
    alt: "Карпальний синдром при вагітності",
    width: 600,
    height: 400,
    title: "Карпальний синдром при вагітності",
  },
]

export function CausesGallery({ images }: CausesGalleryProps) {
