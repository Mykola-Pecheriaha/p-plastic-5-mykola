...
import styles from "./BreastLiftFAQGallery.module.css"
...
interface BreastLiftFAQGalleryProps {
  images: GalleryImage[]
}

export function BreastLiftFAQGallery({ images }: BreastLiftFAQGalleryProps) {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=400&query=breast+lift+faq"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=faq+thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default BreastLiftFAQGallery
