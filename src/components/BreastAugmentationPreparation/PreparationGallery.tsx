...
import type { GalleryImage } from "./BreastAugmentationPreparation"

interface PreparationGalleryProps {
  images: GalleryImage[]
}

const PreparationGallery: React.FC<PreparationGalleryProps> = ({ images }) => {
    ...
    <div className={styles.galleryContainer}>
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={currentImage.src || "/placeholder.svg?height=600&width=800&query=breast augmentation"}
            ...
            {showThumbnails && (
              <div className={styles.thumbnailsContainer}>
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || "/placeholder.svg?height=75&width=100&query=breast augmentation thumbnail"}
                      alt={image.alt}
                      width={100}
                      height={75}
